...
function reasignar_ticket() {
  ...
  var ticket_idx = $("#ticket_idx").val();


  var user_name = $('#usu_id option:selected').text();


  // console.log('usuaio :' + usu_id + ' TICKETid :' + ticket_idx);

  var formData = new FormData();
  formData.append("tick_id", ticket_idx);
  formData.append("usu_id", usu_id);
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      inser_detalle_reasignar(user_name);
    },
  });
  //   location.reload();
}

function inser_detalle_reasignar(user_name) {
  ...
  formData2.append("tick_id", ticket_idx);
  formData2.append("usu_id", usu_id);
  formData2.append("tickd_descrip", "Reasignado a: " + user_name);
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      console.log(data.tickd_id + "la data es del insert detalle");
      actualizarContenido();
      swal("Re-Asignado Correctamente", "" , "success");
