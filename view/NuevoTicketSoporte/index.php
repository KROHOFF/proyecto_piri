...
<html>
	...
	<title>VirtuaNet - Nuevo Ticket</title>
</head>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row">
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput">Usuario Quien Reportó(*)</label>
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								...
								<input type="text" class="form-control" id="tick_telf" name="tick_telf" placeholder="Ingrese Nro Telefono">
							</fieldset>
						</div>
