<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="../../view/Home/" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/LOGO.png" alt="" style="height: 35px; padding-right: 20px; padding-top: 5px;">
            <img class="hidden-lg-up" src="../../public/img/logo_chico.jpg" alt="">
        </a>
