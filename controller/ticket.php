<?php
    ...
    switch($_GET["op"]){
        ...
        case "insert":
            $datos=$ticket->insert_ticket($_POST["usu_id"],$_POST["cat_id"],$_POST["tick_titulo"],$_POST["tick_descrip"],$_POST["prio_id"],$_POST["tick_telf"]);
        ...
        case "listar_filtro_fecha":
            $datos=$ticket->filtrar_ticket_fecha($_POST["fechainicio"],$_POST["fechafin"]);
            $data= Array();
            foreach($datos as $row){
